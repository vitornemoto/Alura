...
namespace ByteBank.Modelos
{
    ...
    public class ContaCorrente
    {
        ...
        /// </summary>
        /// <param name="valor">Representa o valor do saque, deve ser maior que 0 e menor que o <paramref name="valor"/> do <see cref="Saldo"/>.</param>
        /// <exception cref="ArgumentException">Exceção lançada quando um valor negativo é utilizado no argumento <paramref name="valor"/></exception>
        /// <exception cref="SaldoInsuficienteException">Exceção lançada quando o valor de <paramref name="valor"/> é maior que da propriedade <see cref="Saldo"/></exception>
